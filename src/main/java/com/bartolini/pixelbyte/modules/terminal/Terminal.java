package com.bartolini.pixelbyte.modules.terminal;
...
import com.bartolini.pixelbyte.logging.LogLevel;
import com.bartolini.pixelbyte.logging.LogRecordFormatter;
...
import com.bartolini.pixelbyte.modules.terminal.commands.*;
import com.bartolini.pixelbyte.modules.terminal.shell.Shell;
import com.bartolini.pixelbyte.modules.terminal.shell.ShellEnvironment;
import com.bartolini.pixelbyte.modules.terminal.shell.SimpleShell;
import com.bartolini.pixelbyte.modules.terminal.shell.commands.*;
import com.bartolini.pixelbyte.modules.terminal.shell.dispatcher.SimpleDispatcher;
import com.bartolini.pixelbyte.modules.terminal.shell.parser.SimpleParser;
import com.bartolini.pixelbyte.modules.terminal.ui.TerminalUI;
...
public class Terminal extends EngineModule {
    ...
    public Terminal(TerminalUI ui) {
        ...
        environment.addCommand(new CmdLicense());
        ...
        ui.println("[color=blue]PixelByte, version " + Engine.VERSION + "[/color] Copyright (C) 2018-2023 [color=green]Bartolini[/color].\n\n" +
                "[color=light_gray]This program comes with ABSOLUTELY NO WARRANTY; for details type `license'.\n" +
                "This is free software, and you are welcome to redistribute it\n" +
                "under certain conditions; type `license' for details.[/color]\n");
