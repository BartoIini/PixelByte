package com.bartolini.pixelbyte.core;
...
import com.bartolini.pixelbyte.event.EventBus;
import com.bartolini.pixelbyte.logging.*;
...
public class Engine {
     ...
     */
    public static final String NAME = "PixelByte";
